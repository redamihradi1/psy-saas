...
def dashboard_view(request):
    ...
    prochaines_consultations = []
    consultations_du_jour = []
    ...
    # --- CHIFFRE D'AFFAIRES (nécessite l'accès Comptabilité, pas juste Consultations) ---
    ca_mois = 0
    ca_semaine = 0
    tarif_moyen = 0
    duree_moyenne = 60
    ...
    if can_comptabilite:
        ...
        consultations_mois_count = consultations_mois_qs.count()
